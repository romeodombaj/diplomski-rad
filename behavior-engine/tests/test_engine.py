...
def test_an_unworked_day_is_encoded_as_unfamiliar():
    ...
    assert to_vector(ev(5, 9, 0), None, familiar)[2] == 0.0
...
def test_seed_then_score(client: TestClient):
    ...
    normal = score("2026-08-25T08:47:00")
    odd = score("2026-08-30T03:12:00", "SERVER-03")
